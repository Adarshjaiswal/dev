<template>
         <!-- ----------- Awards start -->
    <section
      class=" m-12 awoard__section bg-black bg-common_bg bg-center bg-no-repeat bg-cover rounded-[10px] overflow-hidden xxl:py-[120px] xl:py-[100px] py-[60px] p-5"
    >
      <div
        class="xl:max-w-[1350px] lg:max-w-[960px] md:max-w-2xl sm:max-w-xl xl mx-auto px-3"
      >
        <div
          class="award__wraper table-responsive"
          data-aos="fade-up"
          ...
          <table class="table w-full">
            <tbody>
              <tr>
                ...
                >
                  <span
                    class="table__title md:text-[42px] sm:text-[28px] text-lg "
                    >Our Awards</span
                  >
                </td>
                <td
